...
if __name__ == '__main__':
    # args = parse()
    # run(args)
    trainIters('data/touchpal_done.txt',False,n_iteration=50000,
               learning_rate=0.0001,batch_size=64,n_layers=1,
               hidden_size=512,print_every=500,save_every=1000,dropout=0.1)
